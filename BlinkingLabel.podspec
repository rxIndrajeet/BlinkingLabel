...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
    This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking.
                       DESC
  s.homepage         = 'https://github.com/Indrajeet/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Indrajeet' => 'indrajeet.senger@radixweb.com' }
  s.source           = { :git => 'https://github.com/Indrajeet/BlinkingLabel.git', :tag => s.version.to_s }
